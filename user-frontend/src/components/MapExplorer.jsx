...
export default function Analyze() {
  ...
  const tabs = [
    ...
    },
    {
      "id": 2,
      "tabName": "NDVI",
      "detail": "NDVI, or Normalized Difference Vegetation Index, is a widely used vegetation index in remote sensing and environmental science. It quantifies the density and health of vegetation in an area by measuring the difference between the near-infrared (NIR) and red light reflected by plants. ",
  ...
  return (
    <div>
        <h1 className="font-bold text-3xl">Satellite data awareness program</h1>
        <p>Get to know about various satellite data and how it impacts climate and wildfire risk management.</p>
        <p></p>
